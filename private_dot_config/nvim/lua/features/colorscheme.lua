...
return {
  {
    ...
    opts = {
      ...
      highlights = {
        ...
        diffSubname = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        diffIndexLine = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        diffFile = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        diffLine = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        diffOldFile = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        diffNewFile = { fg = "${blue}", bold = true, extend = true, undercurl = true, italic = true },
        fugitiveUnstagedSection = { fg = "${purple}", bold = true, extend = true, undercurl = true, italic = true },
        fugitiveStagedSection = { fg = "${purple}", bold = true, extend = true, undercurl = true, italic = true },
